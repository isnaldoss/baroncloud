  ...
  return (
    <div className="bg-accent-blue py-2 px-6 hidden md:block">
      <div className="container mx-auto flex justify-between items-center text-[11px] font-bold uppercase tracking-widest text-white">
        ...
        <div className="flex gap-6">
          <a
            href="mailto:suporte@baroncloud.com.br"
            className="hover:text-white/80 transition-colors"
          >
            suporte@baroncloud.com.br
          </a>
...
const Header = () => {
  ...
  const navItems = ["Sobre", "Serviços", "Planos", "Feedback"];
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled
            ...
            : "md:translate-y-8 py-6 bg-transparent"
        }`}
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-bold tracking-[0.2em] text-accent-blue uppercase">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="https://wa.me/5516993496533"
            ...
            <button 
              ...
              className="lg:hidden text-white text-3xl hover:text-accent-blue transition-colors relative z-[60]"
            >
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[55] lg:hidden bg-background flex flex-col items-center justify-center p-6"
          >
            ...
            <div className="flex flex-col items-center gap-8 relative z-10 w-full">
              {navItems.map((item, i) => (
                ...
                >
                  <Link
                    ...
                    className="text-4xl font-black tracking-tighter text-white hover:text-accent-blue transition-colors uppercase"
                  >
                    {item}
                  </Link>
                </motion.div>
              ...
              >
                <Link
                  href="https://wa.me/5516993496533"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center justify-center w-full py-6 bg-accent-blue text-white rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl shadow-accent-blue/20"
                >
                  Ativar Servidor
                </Link>
              </motion.div>
    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Data Center BaronCloud - Infraestrutura de Alta Performance e Servidores Cloud"
          fill
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          >
            Hospedagem com performance dedicada.{" "}
            <br className="hidden md:block" />
            Servidores robustos, segurança máxima e uptime garantido para sua
            empresa.
          </motion.p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <span className="text-accent-blue font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">
              Nossa Infraestrutura
            </span>
            ...
            <p className="text-white/50 text-xl leading-relaxed mb-10 font-medium">
              A BaronCloud oferece servidores de alta performance com
              oferece servidores de alta performance. Nossa infraestrutura é projetada para
              suportar cargas críticas com estabilidade absoluta.
            </p>
            ...
            <div className="space-y-6">
              {[
                {
                  icon: "ri-cpu-line",
                  title: "Processadores de Alta Frequência",
                },
                {
                  icon: "ri-database-2-line",
                  title: "Armazenamento NVMe Enterprise",
                },
                {
                  icon: "ri-global-line",
                  title: "Rede Global de Baixa Latência",
                },
              ].map((item, i) => (
  ...
  const services = [
    {
      ...
      description:
        "Pague apenas pelo que usar com faturamento flexível e escalabilidade instantânea.",
      icon: "ri-time-line",
      badge: "Flexível",
    ...
    },
    {
      ...
      description:
        "Servidores robustos com gestão especializada e foco em estabilidade operacional.",
      icon: "ri-cloud-line",
      badge: "Cloud",
      className: "md:col-span-2 md:row-span-1",
    },
    {
      ...
      description:
        "Backups automáticos e redundância geográfica para total segurança das suas informações.",
    ...
    },
    {
      ...
      description:
        "Conectividade de elite com baixa latência para garantir a melhor experiência aos seus usuários.",
      icon: "ri-pulse-line",
      badge: "Rede",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-white/40 text-xl font-medium">
            Infraestrutura completa para empresas que buscam o próximo nível de
            estabilidade.
          </p>
        </div>
...
const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      period: "/mês",
      description:
        "Solução definitiva para grandes volumes e infraestrutura crítica.",
      features: [
        "100GB SSD NVMe",
        "E-mails Ilimitados",
        "Performance Máxima",
    ...
    <section id="planos" className="py-32 relative">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-white/40 text-xl font-medium">
            Hospedagem profissional com faturamento justo e transparente.
          </p>
        </div>
          ...
          {plans.map((plan, i) => (
            <motion.div
              ...
              className={`relative p-10 rounded-[40px] border ${
                plan.popular
                  ? "bg-accent-blue border-transparent glow-blue"
            ...
            >
              ...
              <div className="mb-6">
                ...
                <span
                  className={`text-sm font-bold ${
                    plan.popular ? "text-white/70" : "text-white/30"
                  }`}
                >
                  {plan.period}
                </span>
              ...
              <p
                className={`mb-8 text-sm font-medium leading-relaxed ${
                  plan.popular ? "text-white/80" : "text-white/40"
                }`}
              >
                {plan.description}
              </p>
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-white/40 text-lg leading-relaxed max-w-md mb-8 font-medium">
              Infraestrutura cloud de elite. A solução
              definitiva para empresas que exigem alta performance e
              estabilidade.
            </p>
            <div className="flex gap-4">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white/40 hover:bg-accent-blue hover:text-white transition-all"
                >
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <a href="mailto:suporte@baroncloud.com.br" className="group">
                <p className="text-white/20 text-[10px] font-black uppercase tracking-widest mb-1">
                  E-mail
                </p>
                <p className="text-white/60 group-hover:text-white transition-colors font-bold">
                  suporte@baroncloud.com.br
                </p>
              </a>
              <a href="https://wa.me/5516993496533" className="group">
                <p className="text-white/20 text-[10px] font-black uppercase tracking-widest mb-1">
                  WhatsApp
                </p>
                <p className="text-white/60 group-hover:text-white transition-colors font-bold">
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-white/20 text-[11px] font-bold uppercase tracking-widest">
            © {new Date().getFullYear()} BaronDesk. High Performance
            Infrastructure.
          </p>
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="fixed bottom-10 right-10 z-[100] w-14 h-14 bg-accent-blue/10 backdrop-blur-xl border border-white/10 text-white rounded-2xl flex items-center justify-center text-2xl shadow-2xl glow-blue group"
        >
          <i className="ri-arrow-up-line transition-transform duration-500 group-hover:-translate-y-1"></i>
        </motion.button>
      )}
    </AnimatePresence>
  );
